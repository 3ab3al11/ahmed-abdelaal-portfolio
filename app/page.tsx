...
const projects: Array<{
  ...
  },
  {
    ...
    subtitle: {
      en: "Secure commerce across a storefront and REST API.",
      ar: "تجارة إلكترونية آمنة عبر واجهة MVC وREST API.",
    },
    description: {
      en: "Two separate .NET 9 applications—an MVC storefront and REST API—covering catalog CRUD, shopping carts, checkout, inventory, orders, filtering, pagination, and image uploads.",
      ar: "تطبيقان منفصلان بـ.NET 9—واجهة متجر MVC وREST API—لإدارة المنتجات والسلة والدفع والمخزون والطلبات والبحث والتصفية وتقسيم الصفحات ورفع الصور.",
    },
    role: {
      en: "Built independently with ASP.NET Core Identity, JWT authentication and refresh tokens, role-based authorization, email and OTP flows, Stripe Checkout, promotional codes, asynchronous EF Core operations, and OpenAPI/Scalar documentation.",
      ar: "طورت المشروع بشكل فردي باستخدام ASP.NET Core Identity ومصادقة JWT مع Refresh Tokens وصلاحيات الأدوار والبريد وOTP وStripe Checkout والأكواد الترويجية وعمليات EF Core غير المتزامنة وتوثيق OpenAPI/Scalar.",
    },
    href: "https://github.com/3ab3al11/E-Commerce-Platform",
    image: "/project-ecommerce.webp",
    imageAlt: {
      en: "E-Commerce Platform project artwork",
      ar: "صورة مشروع منصة التجارة الإلكترونية",
    },
    tech: [".NET 9", "ASP.NET Core MVC", "REST API", "EF Core", "SQL Server", "JWT", "Stripe"],
    stats: [
      ["2", { en: "separate applications", ar: "تطبيقان منفصلان" }],
      ["JWT", { en: "refresh-token auth", ar: "مصادقة مع رمز تحديث" }],
      ["Stripe", { en: "checkout integration", ar: "تكامل الدفع" }],
    ],
  },
  {
    index: "03",
